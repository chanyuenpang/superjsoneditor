...
- `claw-ignore-boundary.md`：记录 `.claw` 的版本控制边界只保留 `.claw/project.json` 与 `.claw/truth/**`，并给出 `git rm -r --cached -- .claw/archive`、`git ls-files .claw` 和 `git status --short --ignored .claw` 的清理核对方式。
